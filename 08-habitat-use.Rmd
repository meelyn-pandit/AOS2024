...
## 8.1 Load libraries and settings
...
### 8.1.2 Load libraries and settings
```{r}
library(dplyr)
library(duckdb)
library(ggplot2)
...
## 8.2 Load Node Health Data from Files
...
## 8.4 Load Station Detection Data
...
# Selected Tag Id - Power Tag on a Swamp Sparrow (SWSP), 1/8 wave, may need to set rssi coefficient lower for detections
