...
### 4.1.1 Node Health - Check Health Records

#### 4.1.1.1 Load Data from Database

The `celltracktech` package has built-in functions to check and plot the battery and solar levels:
...
#### 4.1.1.2 Checking Nodes are operating
...
### 4.1.2 Battery and Solar Levels
