---
title: "Chapter 10 - Multilateration"
author: "meelyn"
date: "2025-03-03"
...
### 10.1.1 Reset R's brain, remove all previous objects
```{r}
rm(list=ls())
...
# filter for specific dates and for the specified tags in tagid
...
## 10.2 Isolate raw Received Signal Strength (RSS) data from Node network associated with Test Data
```{r}
combined_data <- data.setup(mytest, 
                            ...
                            y="lat", 
                            loc_precision=6, 
                            fileloc="./data/meadows/meadows.duckdb", 
                            filetype="raw")
```

## 10.3 Exponential Decay Function - Relationship between Distance and Tag RSS Values
```{r}
...
### 10.3.1 Preliminary Exponential Decay Model - Determine staring values for the final model
...
### 10.3.2 Final Exponential Decay Model
...
ggplot(combined_data, aes(x = distance, y = avgRSS, color=node_id)) + 
  geom_point() +
